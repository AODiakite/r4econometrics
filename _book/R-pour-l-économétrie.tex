...
\hypertarget{part-duxe9buter-avec-r}{%
\part{Débuter avec R}\label{part-duxe9buter-avec-r}}
...
{\centering \includegraphics[width=0.8\linewidth]{02-bases-R_files/figure-latex/nice-fig-1} 
...
\hypertarget{tableau-de-donnuxe9es-ou-data-frame}{%
\subsection{Tableau de données ou Data frame}\label{tableau-de-donnuxe9es-ou-data-frame}}
